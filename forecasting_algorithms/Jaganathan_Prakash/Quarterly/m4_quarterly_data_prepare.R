...
forpro.1 <- read.csv(file="!Project01 Numeric Output quarterly final.csv", header=TRUE, sep=",",strip.white=TRUE)
...
forepro.list <- setNames(split(forpro.2[,c(-1:-5,-14)],seq(nrow(forpro.2))),forpro.2[,2])
